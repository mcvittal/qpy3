...
#Requirements
This package is developed on Linux Mint 17.2, running QGIS 2.0.1 Wien. The library assumes that you have python-qgis installed, and that the processing modules are located in /usr/share/qgis/python/plugins. It is written in Python 2.7. 
